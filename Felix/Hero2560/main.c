...
/*   Updated: 2025/04/22 18:14:35 by fcoullou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define SPEAKER_PIN PB5 // Pin D9 est PB1 sur l'Arduino Uno
...
int main(void)
{
    ...
    // const t_part *music = &simpson;     // Pointer vers la musique à jouer
    ...
    while (1)
    {
        if (end_note)
        {
            ...
            // uart_printstr("Note: ");
            // uart_print_ui16(music->notes[curr_note].freqs[0]);
            // uart_printstr("\n\r");
